...
adult_ticts = st.number_input("Adult Tickets", min_value=0, step=1)

student_ticts = st.number_input("Student Tickets", min_value=0, step=1)

child_ticts = st.number_input("Child Tickets", min_value=0, step=1)
